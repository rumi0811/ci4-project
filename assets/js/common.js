...
function printUserDescription(data, type, full)
{
	...
	var resp = "";
	if (arrData[0] != '')
		resp += '<i class="fal fa-user"></i> '+arrData[0]+'<br />';
	if (arrData[1] != '')
		resp += '<i class="fal fa-phone"></i> '+arrData[1]+'<br />';
	if (arrData[2] != '')
		resp += '<i class="fal fa-home"></i> <small>'+arrData[2]+'</small>';
	return resp;
}
