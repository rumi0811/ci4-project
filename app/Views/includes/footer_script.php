...
<script src="<?= base_url('assets/4.5.1/js/dependency/moment/moment.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/formplugins/select2/select2.bundle.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/datagrid/datatables/datatables.bundle.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/datagrid/datatables/datatables.export.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/notifications/sweetalert2/sweetalert2.bundle.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/notifications/toastr/toastr.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/formplugins/dropzone/dropzone.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/miscellaneous/lightgallery/lightgallery.bundle.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/plugin/jquery-nestable/jquery.nestable.min.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/formplugins/bootstrap-datepicker/bootstrap-datepicker.js') ?>"></script>
<script src="<?= base_url('assets/4.5.1/js/formplugins/bootstrap-daterangepicker/bootstrap-daterangepicker.js') ?>"></script>
