		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">
					<i class="fal fa-upload"></i> Upload Data: <span class="fw-300"><i><?php echo $currentPage['menu_name']; ?></i></span>
				</h4>
			...
			<div class="modal-body no-padding">
				...
				<div class="row">
					...
					<article class="col-sm-12 col-md-12 col-lg-12">
						...
						<hr />
						<form id="form-upload-data-dropzone" action="<?php echo base_url(); ?>repository/upload_file/<?php echo $REPOSITORY_NAME; ?>" class="dropzone">
						...
						<form id="form-upload-data" method="post" action="<?php echo base_url(); ?>upload_data/post/<?php echo $REPOSITORY_NAME; ?>">
							<input type="hidden" name="session_file_hash" value="<?php echo $session_file_hash; ?>" />
							<input type="hidden" name="btnUpload" value="1" /> 
